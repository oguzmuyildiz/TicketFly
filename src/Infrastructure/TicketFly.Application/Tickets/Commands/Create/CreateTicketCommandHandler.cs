...
public class CreateTicketCommandHandler(ILogger<CreateTicketCommandHandler> logger, IAppDbContext context) : 
    IRequestHandler<CreateTicketCommand, Result<Guid>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("Ticket created with ID: {Id}", entity.Id);
