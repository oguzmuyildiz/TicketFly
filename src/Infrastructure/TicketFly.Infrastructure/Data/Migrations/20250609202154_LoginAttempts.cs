        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailAccounts_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketAlarmRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketAlarmRules_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppNotifications_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppNotifications_RoleId",
                table: "AppNotifications",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailAccounts_OrganizationId",
                table: "EmailAccounts",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAlarmRules_OrganizationId",
                table: "TicketAlarmRules",
                column: "OrganizationId");
